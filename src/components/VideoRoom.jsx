      ...
      <div className="bg-gray-800 bg-opacity-90 p-4 rounded-lg">
        <div className="flex items-center justify-center gap-4 max-w-xl mx-auto">
          <button
            ...
            } text-white font-medium hover:opacity-90 transition-opacity focus:outline-none shadow-lg flex items-center gap-2`}
          >
            {isMuted ? "Unmute" : "Mute"}
          </button>
          ...
          <button
            onClick={leaveRoom}
            className="px-6 py-3 rounded-full bg-red-600 text-white font-medium hover:bg-red-700 transition-colors focus:outline-none shadow-lg flex items-center gap-2"
          >
            Leave Room
          </button>
        </div>
